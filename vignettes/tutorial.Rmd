...
Here we see a very consistent association across all ancestries. Note that the `All` estimate is slightly more precisely estimated than any of the others because it is combining similar estimates.
